        ...
        <div class="listing-card card h-100">
          ...
          <div class="card-body d-flex flex-column">
            <div class="d-flex justify-content-between align-items-start mb-2">
              <h5 class="card-title mb-0 fw-bold">${listing.crop_name}</h5>
              ${badge}
            </div>
            <div class="mb-2">
            ...
            <div class="text-muted small mb-1"><i class="bi bi-boxes"></i> ${listing.quantity} ${listing.unit} available</div>
            <div class="text-muted small mb-1"><i class="bi bi-geo-alt"></i> ${listing.district}, ${listing.state}</div>
            <div class="text-muted small mb-3"><i class="bi bi-person"></i> ${listing.farmer_name}</div>
            <div class="mt-auto">
              <button class="btn btn-primary w-100" onclick="openInterestModal('${listing._id}', '${listing.crop_name}', ${listing.quantity}, '${listing.unit}')">
                <i class="bi bi-send"></i> Send Interest
              </button>
            </div>
          </div>
        </div>
